...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        button = [[[UIButton alloc] initWithFrame:CGRectMake(frame.size.width/2-okImage.size.width/2, 10, okImage.size.width, okImage.size.height)] autorelease];
        [button setImage:okImage forState:UIControlStateNormal];
        [button addTarget:self action:@selector(controlAction:) forControlEvents:UIControlEventTouchUpInside];
        ...
        button = [[[UIButton alloc] initWithFrame:CGRectMake(10, frame.size.height/2-okImage.size.height/2, okImage.size.width, okImage.size.height)] autorelease];
        [button setImage:okImage forState:UIControlStateNormal];
        [button addTarget:self action:@selector(controlAction:) forControlEvents:UIControlEventTouchUpInside];
        ...
        button = [[[UIButton alloc] initWithFrame:CGRectMake(frame.size.width/2-okImage.size.width/2, frame.size.height-okImage.size.height-10, okImage.size.width, okImage.size.height)] autorelease];
        [button setImage:okImage forState:UIControlStateNormal];
        [button addTarget:self action:@selector(controlAction:) forControlEvents:UIControlEventTouchUpInside];
        ...
        button = [[[UIButton alloc] initWithFrame:CGRectMake(frame.size.width-okImage.size.width-10, frame.size.height/2-okImage.size.height/2, okImage.size.width, okImage.size.height)] autorelease];
        [button setImage:okImage forState:UIControlStateNormal];
        [button addTarget:self action:@selector(controlAction:) forControlEvents:UIControlEventTouchUpInside];
