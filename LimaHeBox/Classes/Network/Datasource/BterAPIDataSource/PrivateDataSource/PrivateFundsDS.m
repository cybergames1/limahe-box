...
- (void)funds
{
    ...
    /** 参数 图片data */
    PPQPostDataRequest *request_ = [[PPQPostDataRequest alloc] initWithDelegate:self theURl:[NSURL URLWithString:@"https://bter.com/api/1/private/getfunds"]];
